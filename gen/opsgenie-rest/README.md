## Swagger Auto-Generated [http-client](https://www.stackage.org/lts-9.0/package/http-client-0.5.7.0) Bindings to `OpsgenieREST` 

The library in `lib` provides auto-generated-from-Swagger [http-client](https://www.stackage.org/lts-9.0/package/http-client-0.5.7.0) bindings to the OpsgenieREST API.
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OpsgenieREST.Client    | use the "dispatch" functions to send requests       |
| OpsgenieREST.Core      | core funcions, config and request types             |
| OpsgenieREST.API       | construct api requests                              |
| OpsgenieREST.Model     | describes api models                                |
| OpsgenieREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OpsgenieREST.ModelLens | lenses for model fields                             |
| OpsgenieREST.Logging   | logging functions and utils                         |
