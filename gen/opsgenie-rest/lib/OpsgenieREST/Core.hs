...
module OpsgenieREST.Core where
...
-- | 
data OpsgenieRESTConfig = OpsgenieRESTConfig
...
-- | display the config
instance P.Show OpsgenieRESTConfig where
  show c =
    T.printf
...
-- | constructs a default OpsgenieRESTConfig
--
-- configHost:
--
...
--
newConfig :: IO OpsgenieRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ OpsgenieRESTConfig
        { configHost = "https://api.opsgenie.com"
...
addAuthMethod :: AuthMethod auth => OpsgenieRESTConfig -> auth -> OpsgenieRESTConfig
addAuthMethod config@OpsgenieRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OpsgenieRESTConfig -> IO OpsgenieRESTConfig
...
withStderrLogging :: OpsgenieRESTConfig -> IO OpsgenieRESTConfig
...
withNoLogging :: OpsgenieRESTConfig -> OpsgenieRESTConfig
...
data OpsgenieRESTRequest req contentType res accept = OpsgenieRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of OpsgenieRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OpsgenieRESTRequest
  , rParams   :: Params -- ^ params of OpsgenieRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OpsgenieRESTRequest req contentType res accept) NH.Method
rMethodL f OpsgenieRESTRequest{..} = (\rMethod -> OpsgenieRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OpsgenieRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OpsgenieRESTRequest{..} = (\rUrlPath -> OpsgenieRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OpsgenieRESTRequest req contentType res accept) Params
rParamsL f OpsgenieRESTRequest{..} = (\rParams -> OpsgenieRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OpsgenieRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OpsgenieRESTRequest{..} = (\rAuthTypes -> OpsgenieRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OpsgenieRESTRequest req contentType res accept -> param -> OpsgenieRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OpsgenieRESTRequest req contentType res accept -> param -> OpsgenieRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OpsgenieRESTRequest req contentType res accept -> param -> OpsgenieRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** OpsgenieRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> OpsgenieRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = OpsgenieRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: OpsgenieRESTRequest req contentType res accept -> [NH.Header] -> OpsgenieRESTRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: OpsgenieRESTRequest req contentType res accept -> [NH.HeaderName] -> OpsgenieRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => OpsgenieRESTRequest req contentType res accept -> OpsgenieRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => OpsgenieRESTRequest req contentType res accept -> OpsgenieRESTRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: OpsgenieRESTRequest req contentType res accept -> [NH.QueryItem] -> OpsgenieRESTRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: OpsgenieRESTRequest req contentType res accept -> WH.Form -> OpsgenieRESTRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: OpsgenieRESTRequest req contentType res accept -> NH.Part -> OpsgenieRESTRequest req contentType res accept
...
_setBodyBS :: OpsgenieRESTRequest req contentType res accept -> B.ByteString -> OpsgenieRESTRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: OpsgenieRESTRequest req contentType res accept -> BL.ByteString -> OpsgenieRESTRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => OpsgenieRESTRequest req contentType res accept -> P.Proxy authMethod -> OpsgenieRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: OpsgenieRESTConfig
    -> a
    -> OpsgenieRESTRequest req contentType res accept
    -> IO (OpsgenieRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OpsgenieRESTConfig
  -> IO (OpsgenieRESTRequest req contentType res accept)
_applyAuthMethods req config@(OpsgenieRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
